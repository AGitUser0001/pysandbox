...
def run_sandboxd(
  ...
  compilation_cache: str | PathLike[str] | None,
  cache_vfs: bool,
...
class SandboxProcess:
  ...
  def run(
    ...
    *,
    ...
    package_paths: list[str | PathLike[str]] = [],
...
class OutputEvent:
  def __init__(self, source: Literal["stdout", "stderr"], data: bytes) -> None: ...
  @property
  def source(self) -> Literal["stdout", "stderr"]: ...
  @property
  def data(self) -> bytes: ...
...
class Output:
  ...
  def len(self) -> int: ...
  def get_item(self, index: int) -> OutputEvent: ...
  def get_slice(self, start: int, stop: int, step: int) -> list[OutputEvent]: ...
...
def start_sandbox(
  ...
  *,
  ...
  compilation_cache: str | PathLike[str] | None = None,
